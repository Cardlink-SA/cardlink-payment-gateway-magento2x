...
/**
 * Information block for Google Pay payment method order display.
 *
 * @author Cardlink S.A.
 */
class InfoGooglePay extends \Magento\Payment\Block\Info
{
    /**
    ...
    /**
     * Prepare Google Pay payment info for display.
     *
    ...
    protected function _prepareSpecificInformation($transport = null)
    {
        ...
        if ($this->getInfo()->getMethod() == \Cardlink\Checkout\Model\Config\SettingsGooglePay::CODE) {
