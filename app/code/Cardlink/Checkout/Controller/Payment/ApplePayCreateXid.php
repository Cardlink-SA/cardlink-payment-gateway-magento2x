 ...
 *
 * Magento route: cardlink_checkout/payment/applepaycreatexid
 *
 * @author Cardlink S.A.
 */
class ApplePayCreateXid extends Action implements CsrfAwareActionInterface
{
    /**
     * @var Logger
     */
    ...
    public function execute()
    {
        ...
        try {
            ...
            $this->logger->debug(
                "ApplePayCreateXid: trId={$trId}, trExtId={$trExtId}, "
            ...
            $this->logger->error('ApplePayCreateXid error: ' . $e->getMessage());
