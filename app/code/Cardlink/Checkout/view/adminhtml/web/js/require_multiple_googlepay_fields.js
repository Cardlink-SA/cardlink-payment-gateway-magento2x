define('Cardlink_Checkout/js/require_multiple_googlepay_fields', [
    'jquery',
    'mage/adminhtml/form'
], function ($) {
    'use strict';
    ...
    return function (config) {
        var paymentMethodActive = $('#payment_other_cardlink_checkout_googlepay_active');

        // Array of field IDs to validate conditionally
        var fieldsToValidate = [
            '#payment_other_cardlink_checkout_googlepay_merchant_id',
            '#payment_other_cardlink_checkout_googlepay_shared_secret'
        ];
